...
import MiotProperty from './types/miot/MiotProperty'
import MiotDevice from './types/miot/MiotDevice'
...
export default class extends EventEmitter {
    ...
    private propertiesToMonitor: {
        [key: string]: MiotProperty & { siid: number; desc: string }
    }
    ...
    async init(): Promise<PropertiesMap> {
        ...
        const deviceData = JSON.parse(data.toString()) as MiotDevice
